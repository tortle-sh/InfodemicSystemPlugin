...
void UIDS_InformationCollection::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	FDefaultObserverConfig Config;
	Config.CollectObjectsFrom = Parents;
	Config.FilteredClass = UIDS_InformationBundle::StaticClass();
	this->InheritedInformationObserver.InitializeObserver(Config);
